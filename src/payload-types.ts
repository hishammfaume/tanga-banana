...
export interface Config {
  ...
  collections: {
    ...
    'blog-tags': BlogTag;
    blogs: Blog;
    'tour-reservations': TourReservation;
  ...
  collectionsSelect: {
    ...
    'tour-reservations': TourReservationsSelect<false> | TourReservationsSelect<true>;
  ...
  fallbackLocale: ('false' | 'none' | 'null') | false | null | ('en' | 'sw') | ('en' | 'sw')[];
  globals: {};
  globalsSelect: {};
  locale: 'en' | 'sw';
  user: User;
...
export interface Blog {
  ...
  thumbnail?: (number | null) | BlogImage;
  author: number | User;
  authorName: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tour-reservations".
 */
export interface TourReservation {
  id: number;
  date: string;
  timePreference?: ('morning' | 'afternoon' | 'fullday') | null;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'tour-reservations';
        value: number | TourReservation;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tour-reservations_select".
 */
export interface TourReservationsSelect<T extends boolean = true> {
  date?: T;
  timePreference?: T;
  timezone?: T;
  durationMinutes?: T;
